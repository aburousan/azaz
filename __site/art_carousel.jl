function hfun_art_carousel()
    ...
    <div class="omnitrix-container" id="omnitrix">
      ...
      <div class="omnitrix-hologram">
        <img id="omnitrix-main-display" src="/assets/art/$(files[1])" alt="Holographic Art" />
      </div>
    ...
    <script>
      ...
      function updateDial() {
        ...
        items.forEach((item, index) => {
          ...
          let diff = (index - (currentDialIndex % totalDialItems)) % totalDialItems;
          ...
          } else if (diff === 1 || diff === totalDialItems - 1) {
